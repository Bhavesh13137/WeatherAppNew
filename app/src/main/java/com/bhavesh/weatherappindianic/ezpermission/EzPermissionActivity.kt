package com.bhavesh.weatherappindianic.ezpermission
...
internal class EzPermissionActivity : AppCompatActivity() {
    ...
    private fun getRequestedPermissions() = intent.getStringArrayExtra(EzResult.EXTRA_REQUESTED_PERMISSIONS)!!
